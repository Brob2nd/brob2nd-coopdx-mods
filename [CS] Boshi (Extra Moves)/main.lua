...
Boshi = {
    ...
    -----------
    {
        ...
        anims = {
            [CS_ANIM_MENU] = "cs_boshi_em",
        }
    },
}

local BoshiCreditsEM = {
    {
        name = TEXT_PACK_NAME,
        "Brob2nd,Lead Dev",
        "Sharen,Animation",
    ...
    },
    {
        ...
        "Squishy6094,Ground Pound Cancel",
...
local function on_character_select_load()
    ...
    for i = 1, #BoshiCreditsEM do
        for c = 1, #BoshiCreditsEM[i] do
            local creditSplit = string.split(BoshiCreditsEM[i][c], ",")
            charSelect.credit_add(BoshiCreditsEM[i].name, creditSplit[1], creditSplit[2])
        end
    end
end
