...
local function on_character_select_load()
    for i = 1, #csBoshiem do
        local char = csBoshiem[i]
...
local function on_character_sound(m, sound)
    ...
    for i = 1, #csBoshiem do
        if _G.charSelect.character_get_voice(m) == csBoshiem[i].voices then return _G.charSelect.voice.sound(m, sound) end
    end
end
